...
describe('mint', () => {
  it('should prepare the mint transaction', async () => {
    ...
    expect(tx.data).toEqual(
      '0x156e29f6000000000000000000000000c388fbef54c899a46a826ee5b5b38048d8e44d2a7c87c17d6f360b864fb885ac69aeca732f99c5726cbba7287e9d244785fac37d0000000000000000000000000000000000000000000000000de0b6b3a7640000'
    )
