...
describe("mint", () => {
  it("should prepare the mint transaction", async () => {
    ...
    expect(tx.data).toEqual(
      "0x156e29f6000000000000000000000000cca30d2818c2d7de99e25c33dc96893c8310f0317c87c17d6f360b864fb885ac69aeca732f99c5726cbba7287e9d244785fac37d0000000000000000000000000000000000000000000000000de0b6b3a7640000"
    )
