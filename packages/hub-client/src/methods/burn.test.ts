...
describe('burn', () => {
  it('should prepare the burn transaction', async () => {
    ...
    expect(tx.data).toEqual(
      '0xf5298aca000000000000000000000000c388fbef54c899a46a826ee5b5b38048d8e44d2a608f90e3bbeae09ffadfa800ff18d38c3147f3b1460c503822e8bbfed759714c0000000000000000000000000000000000000000000000000de0b6b3a7640000'
    )
