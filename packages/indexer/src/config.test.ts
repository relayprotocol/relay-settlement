  ...
  assert.throws(
    () =>
      validateRuntimeConfig({
        ...
        balanceDriftAuditBatchSize: 25,
        balanceDriftAuditEnabled: true,
        balanceDriftAuditGraceBlocks: 250,
        batchSize: 2000,
        ...
        indexerDriftAutoReconcileBatchSize: 25,
        indexerDriftAutoReconcileEnabled: true,
        indexerDriftAutoReconcileStaleMs: 10 * 60 * 1000,
