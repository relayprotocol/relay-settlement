...
import {
  encodeBitcoinAddressToHex,
  normalizeBitcoinAddressHex,
} from "../../../common/address/bitcoin.js";
...
const BTC_NATIVE = encodeBitcoinAddressToHex(
...
export function assertBitcoinDepositTransaction(
  ...
  if (normalizeBitcoinAddressHex(trigger.input.currency) !== BTC_NATIVE) {
  ...
  const encodedDepositor = encodeBitcoinAddressToHex(depositor).toLowerCase();
