...
contract ERC20View {
    ...
    error ERC20ViewTransferFailed(address from, address to, uint256 tokenId, uint256 value);
    error ERC20ViewInsufficientAllowance(address spender, uint256 allowance, uint256 needed);
        ...
        if (msg.sender != from) {
            ...
            if (currentAllowance < type(uint256).max) {
                if (currentAllowance < value) {
                    revert ERC20ViewInsufficientAllowance(msg.sender, currentAllowance, value);
                }
                unchecked {
